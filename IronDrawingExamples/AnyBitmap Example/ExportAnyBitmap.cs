...
<p>To export AnyBitmap file to other image formats, simply load AnyBitmap file and use <code>.ExportFile()</code> method. This method has 3 overloads, which are the <strong>exported file name</strong>, <strong>Image format</strong>, and <strong>Image loss</strong>. The exported image can be in format:</p>
<ul>
    <li> Bmp</li>
    <li> Gif</li>
    <li> Png</li>
