...
<p>To use this feature, simply load AnyBitmap file from a file path and assign it to a  **string**  variable to store the string of the AnyBitmap file loaded using the method <code>.ToString()</code> </p>
**/
